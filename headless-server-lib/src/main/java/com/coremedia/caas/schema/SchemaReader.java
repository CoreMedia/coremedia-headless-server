...
import com.coremedia.caas.schema.field.content.model.grid.PageGridField;
import com.coremedia.caas.schema.field.content.model.navigation.ChildrenField;
import com.coremedia.caas.schema.field.content.model.navigation.ContextField;
import com.coremedia.caas.schema.field.content.model.navigation.NavigationPathField;
import com.coremedia.caas.schema.field.content.model.settings.SettingsField;
...
public class SchemaReader extends YamlConfigReader {
  ...
  private Set<TypeDefinition> readTypeDefinitions() throws IOException {
    ...
    constructor.addTypeDescription(new TypeDescription(ChildrenField.class, new Tag("!Children")));
