...
public class ServiceConfig {
  ...
  @Bean
  public MapOfScalars createMapsOfScalars(@Qualifier("dataFetcherConversionService") ConversionService conversionService) {
    return new MapOfScalars(conversionService);
  }
}
